import { View, Heading, Button, Flex, Box, Text, Spacer, HStack, Avatar, VStack, FlatList, ScrollView } from 'native-base'
  ...
  return (
    ...
    <ViewWithBars>
      <View>
        ...
        <ScrollView axW='300' h='80' _contentContainerStyle={{
          px: '20px',
          mb: '4',
          minW: '72'
        }}>
